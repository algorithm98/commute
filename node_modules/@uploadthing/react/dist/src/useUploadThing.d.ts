...
export declare const INTERNAL_uploadthingHookGen: <TRouter extends FileRouter>() => <TEndpoint extends keyof TRouter>(endpoint: TEndpoint, opts?: UseUploadthingProps<TRouter> | undefined) => {
    readonly startUpload: (...args: undefined extends inferEndpointInput<TRouter[TEndpoint]> ? [files: File[], input?: undefined | undefined] : [files: File[], input: inferEndpointInput<TRouter[TEndpoint]>]) => Promise<{
        fileUrl: string;
        fileKey: string;
    }[] | undefined>;
